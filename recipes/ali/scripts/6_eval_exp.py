...
if __name__ == "__main__":
    ...
    for name, ckpt_path_suffix in CKPT_PATH_DICT.items():
        ...
        ckpt_paths = [Path("/home/ids/smao-22/phd/neural-fcasa/recipes/ali/models/neural-fcasa/outputs/dist=Gaussian-param=2/checkpoints/epoch=196-val_loss=-39.5421.ckpt")]
